    ...
    <div>
        ...
        <div class="container">
            <div class="d-inline-block resp">
                <h1 class="mb-4">FIÓK LÉTREHOZÁS </h1>
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback emailError">Az email cím megadása kötelező!</div>
                    </div>

                    <div class="form-group">
                        <label for="password">Jelszó</label>
                        <input type="password" class="form-control password" id="register-password" placeholder="*******">
                        <div class="invalid-feedback passwordError">A jelszó megadása kötelező!</div>
                    </div>

                    <button type="button" id="signup" class="btn">Regisztrálás</button>
                </form>

                <div class="mt-3">
                    <p>Már van fiókod? <a href="..\login\login-page.php">Lépj be!</a></p>
                </div>
            </div>
        </div>
    </div>
