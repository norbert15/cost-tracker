        ...
        <div class="container">
            <div class="d-inline-block resp">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="password-confirm"><?php echo $passwordConfirmed ?></label>
                        <input type="password" class="form-control" id="password-confirm" placeholder="*******">
                        <div class="invalid-feedback p-con"><?php echo $passwordConfirmedFeedback ?></div>
                    </div>

                    <input type="checkbox" id="privacyStatement">
                    <a type="button" data-toggle="modal" data-target="#modal-ps"><?php echo $privacyStatement ?></a>
                    <div class="invalid-feedback ps"></div>

                    <button type="button" id="signup" class="btn mt-3"><?php echo $register ?></button>
                </form>
