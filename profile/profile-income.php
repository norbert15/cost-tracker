            ...
            <div class="d-flex justify-content-center mt-4 icon-margin progress-income">
                <div class="progress vertical">
                    <p class="p-income d-flex justify-content-center p-2" data-toggle ="tooltip" 
                        title=" <?php echo number_format($incomePercent[0]) . "%"?>">
                        <?php echo number_format($incomePercent[0]) . "%" ?>
                    </p>
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" 
                        style="background-color: rgb(202, 13, 13); width: <?php echo number_format($incomePercent[0]) ?>%;">
                    </div>
                </div>
                <div class="progress vertical" style="margin-left: -40px;">
                    <p class="p-income d-flex justify-content-center p-2" data-toggle="tooltip" 
                        title=" <?php echo number_format($incomePercent[1]) . "%" ?>">
                        <?php echo number_format($incomePercent[1]) . "%" ?>
                    </p>
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" 
                        style="background-color:  dodgerblue; width: <?php echo number_format($incomePercent[1]) ?>%;">
                    </div>
                </div>
            </div>
            <!--Progress vége-->
